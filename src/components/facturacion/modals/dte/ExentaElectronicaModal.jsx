...
const DOC_CONFIG = {
  ...
  description: "Completa los datos para emitir una Exenta Electrónica (DTE 34).",
};
...
export default function ExentaElectronicaModal({ isOpen, setIsOpen }) {
  ...
  // Futura función para el sistema de transporte.
            ...
            <div className="flex flex-col items-center gap-6 p-10 text-center w-full max-w-sm">
              ...
              {isSubmitting ? (
                ...
                <>
                  ...
                  <h3 className="text-2xl font-bold text-white uppercase italic tracking-tighter">¡Exenta Emitida!</h3>
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto p-1">
            ...
            <div className="p-4 bg-white/5 rounded-lg border border-white/10 space-y-1 mt-2">
              <div className="flex justify-between text-xl font-bold border-white/10">
                <span>Total DTE:</span>
            ...
            <DialogFooter>
              ...
              <Button type="submit" className="bg-blue-600 hover:bg-blue-700">Emitir Exenta</Button>
            </DialogFooter>
          </form>
        </div>
      </DialogContent>
